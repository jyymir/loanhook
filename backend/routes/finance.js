...
router.get('/loaninterest/', (req, res) => {
  ...
  if (isNaN(amount) || isNaN(rate) || isNaN(years)) {
    return res.status(400).json({ error: 'Invalid input. Please provide amount, rate, and years as query parameters.' });
  }
  ...
  res.json({
    ...
    message: "Based on the provided loan details, your monthly payment will be $" + monthlyPayment.toFixed(2) + ". Over the course of " + years + " years, you will pay a total of $" + totalPayment.toFixed(2) + ", which includes $" + totalInterest.toFixed(2) + " in interest."
  });
